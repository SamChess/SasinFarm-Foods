		...
		<div class="container">
			<div class="agile-contact-form">
				<div class="agileinfo-contact-form-grid">
					<form name="log in" action="process_user.php"
						 method="POST">
						<fieldset>
							<p>Please,fill in this form to create an account.</p>
							<label for='name' >Firstname: </label><br>
							<input type='text' name='firstname' id='first_name' maxlength="50" required /><br>
							<label for='name' >Lastname: </label><br>
							<input type='text' name='lastname' id='second_name' maxlength="50" required /><br>
							...
							<input type='date' name='dob' id='dob' maxlength="50" required/><br>
							<label for='password' >Password:</label><br>
							<input type='password' name='password' id='password' maxlength="50" required /><br>
							<label for='password' >Confirm Password:</label><br>
							<input type='password' name='password1' id='password1' maxlength="50" required /><br>
							<button type="submit "class="btn1" value="submit" name="submit">Submit</button>
						</fieldset>
						<br>
						<p>You already have an account?<a href="log in.php">Log in</a></p>
					</form>
				</div>
			</div>
			<div class="clearfix"> </div>
