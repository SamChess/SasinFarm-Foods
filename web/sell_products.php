				...
				<div class="agile-contact-form">
					...
					<form name="sell_products" action="process_post.php"method="POST" enctype="multipart/form-data">
						<fieldset class="fieldset2">
							...
							<input type='checkbox' name='units' value='Kilograms'/> Kilograms<br>
							<input type='checkbox'name='units' value='Grams'/> Grams<br>
							<input type='checkbox'name='units' value='Piece'/> Piece<br>
							<input type='checkbox'name='units' value='Tray'/> Tray<br>
							<input type='checkbox'name='units' value='Bunch'/> Bunch<br>
							...
							<label for="price">Unique Farmer's Code:</label><br>
							<input type="text" id="farmer_code" class="select" name="farmer_code" style="width:100%" required><br>
