					...
					<div class="top-nav">
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								...
								<li><a class="list-border1" href="log in.php"styles="float:right">Log In</a></li>
							</ul>
							<div class="clearfix"> </div>
						</div>
					</nav>
					...
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/g6.jpg" data-lightbox="example-set" data-title="">
								...
								<figcaption>
								<h3>Ripe <span>Bananas</span></h3>
								<p> Sweet and reaady for sale bananas</p>
								</figcaption>
							</a>
						</figure>
					</div>
					...
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/g1.jpg" data-lightbox="example-set" data-title="">
								...
								<figcaption>
								<h3>Ready <span>Beet roots</span></h3>
								<p>Nice beet roots for sale</p>
								</figcaption>
							</a>
						</figure>
					</div>
					...
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/g2.jpg" data-lightbox="example-set" data-title="">
								...
								<figcaption>
								<h3>Green  <span>Apples</span></h3>
								<p>Wonderful green apples available</p>
								</figcaption>
							</a>
						</figure>
					</div>
					...
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/g3.jpg" data-lightbox="example-set" data-title="">
								...
								<figcaption>
								<h3>Red <span>Apples</span></h3>
								<p>The best red apples you can find locally</p>
								</figcaption>
							</a>
						</figure>
					</div>
					...
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/g4.jpg" data-lightbox="example-set" data-title="">
								...
								<figcaption>
								<h3>Red-Green<span>Apples</span></h3>
								<p>Nutritious fruits indeed</p>
								</figcaption>
							</a>
						</figure>
					</div>
					...
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/g5.jpg" data-lightbox="example-set" data-title="">
								...
								<figcaption>
								<h3>Yellow<span>Oranges</span></h3>
								<p>Wonderful fruits indeed</p>
								</figcaption>
							</a>
						</figure>
					</div>
			...
			<div class="agile-footer-grids">
				...
				<div class="col-md-3 w3-agile-footer-grid">
					...
					<ul>
						...
						<li class="text"><a href="gallery.php">Gallery</a></li>
						<li class="text"><a href="log in.php">Log in</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3-agile-footer-grid">
					<h3>Newsletter</h3>
